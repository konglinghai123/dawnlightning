...
public class ConsultFrag extends Fragment implements IXListViewRefreshListener, IXListViewLoadMore{
	...
	private void initComponent(){
		 ...
		 titlebar.showLeftAndRight("", getResources().getDrawable(R.drawable.app_back),getResources().getDrawable(R.drawable.edit),null,new OnClickListener() {
				...
				if(!result.isEmpty() ){
					...
					if("0".equals(b.getCode().toString().trim())){
						...
						while (iterator.hasNext()){ 
							...
							Log.e("str", s);
							//String id=s.substring(1,s.indexOf(":"));
							//String name=s.substring(s.indexOf(":")+1);
							//JSONObject classid=(JSONObject) JSON.parse(s);
