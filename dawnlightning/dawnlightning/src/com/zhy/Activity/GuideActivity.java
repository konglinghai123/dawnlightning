...
public class GuideActivity extends Activity { 
    ...
    public void onCreate(Bundle savedInstanceState) { 
        ...
        for(int i=0;i<pageViews.size();i++){ 
            ...
            if(i==0){ 
                imageViews[i].setBackgroundResource(R.drawable.btn_back_pressed); 
            }else{ 
                imageViews[i].setBackgroundResource(R.drawable.btn_back_normal); 
            } 
    ...
    private Button.OnClickListener  Button_OnClickListener = new Button.OnClickListener() { 
        public void onClick(View v) { 
            ...
            mIntent.setClass(GuideActivity.this, MainActivity_1.class); 
    ...
    class RegisterOnclick implements OnClickListener{
    ...
    class GuidePageChangeListener implements OnPageChangeListener{ 
        ...
        public void onPageSelected(int position) { 
            ...
            for(int i=0;i<imageViews.length;i++){ 
                imageViews[position].setBackgroundResource(R.drawable.btn_back_pressed); 
